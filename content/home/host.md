...
title: Montréal </br>
subtitle: <h2 style="color:white;">Welcome!<br>Bienvenue!</h2>

design:
  columns: "2"
  background:
    image: venue/montreal.jpg
    image_darken: 0.35
...
### See also our [Registration](registration/), [Venue](venue/), [Travel](travel/) & [Lodging](lodging/) pages.
